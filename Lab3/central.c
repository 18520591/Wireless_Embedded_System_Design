...
static uint8_t adv_raw_data[14] = {0x0D,0x09,0x4c,0x6f,0x6e,0x67,0x2d,0x54,0x68,0x65,0x2d,0x44,0x61,0x74};
static uint8_t scan_rsp_raw_data[28] = {0x1B,0x16,0x31,0x38,0x35,0x32,0x31,0x34,0x32,0x33,0x2d,0x31,0x38,0x35,0x32,0x31,0x30,0x32,0x31,0x2d,0x31,0x38,0x35,0x32,0x30,0x35,0x39,0x31};
...
void app_main() {
	...
	ESP_ERROR_CHECK(esp_ble_gap_config_adv_data_raw(adv_raw_data, 14));
	printf("- ADV data configured\n");
	
	// configure the adv response data
	ESP_ERROR_CHECK(esp_ble_gap_config_scan_rsp_data_raw(scan_rsp_raw_data, 28));
	printf("- adv response data configured\n\n");
}